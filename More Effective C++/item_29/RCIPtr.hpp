...
//
// RCIPtr template is based on the idea of RCPtr; 'I' stands for indirect
//
// (1) add a new class, CountHolder, to actually hold the reference count
// (2) Countholder will contain the dumb pointer to a class Widget (used here as example)
// 
template<class T>
class RCIPtr {
public:
